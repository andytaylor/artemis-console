...
export const CreateQuickFilter: React.FC<CreateQuickFilterProps> = (props) => {
    ...
    const  addFilter = () => {
        if (filterOperation && filterColumn) {
            ...
            const updatedFilters = [...props.quickFilter.tableFilters.searchFilters];
            updatedFilters.push(filter);
            const updatedQuickFilter: SavedTableFilter = {
    ...
    const deleteFilter = (id: string) => {
        const copyOfFilters = [...props.quickFilter.tableFilters.searchFilters];
    ...
    return <>
        <Form label={'Create ' + props.quickFilter.view + ' Quick Filter'}>
            ...
            <FormGroup label="Filter">
                <ChipGroup>
                    {props.quickFilter.tableFilters.searchFilters.map((filter) => (
            ...
            <FormGroup label="Sort Direction">
                <FormSelect label="sort column"
                    aria-label="Select Input"
                    onChange={(_e, selection) => {
                        updateQuickFilterNameSortDirection(selection, props.quickFilter.tableFilters.sortColumn); }}
                    value={props.quickFilter.tableFilters.sortOrder}
                    >
